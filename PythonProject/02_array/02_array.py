...
# 배열을 오름차순 정렬을 한 후, 배열의 첫번째 값 꺼내기(최소값)
# 배열의 마지막 값 꺼내기(최대값)
...
looto2 = [5, 9, 16, 25, 28, 33]
looto3 = [4, 7, 24, 25, 38, 41]
lotto4 = [6, 12, 14, 25, 33, 38]
lotto5 = [3, 8, 17, 21, 23, 37]

#lotto = [lotto1, looto2, lotto3, lotto4, lotto5]
